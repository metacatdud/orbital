...
var _ orbital.ContainerComponent = (*TaskbarStartComponent)(nil)
var _ orbital.StateControl = (*TaskbarStartComponent)(nil)

func NewTaskbarStartComponent(di *orbital.Dependency) *TaskbarStartComponent {
